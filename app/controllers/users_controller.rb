class UsersController < ApplicationController
  ...
  def current
    render json: {id: current_user.id, first_name: current_user.first_name, last_name: current_user.last_name, completed: current_user.completed, pic: current_user.pic, completed: current_user.completed}
  end
end
